...
if __name__ == "__main__":
    saida = open("output/relatorio.txt", "a+")
    saida.writelines("\n\n-------NOVA TENTATIVA-------\n\n")
    ...
    for pat in patients:
        ...
        sol_pat = differential_evolution(cost_func, bounds, args=(pat,10**pat[0]), maxiter=50, popsize=50, mutation=0.5, recombination=0.7,updating='deferred',workers=-1)
