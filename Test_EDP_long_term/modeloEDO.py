...
#V0 = 10**6.208568  #PATC05
#V0 = 10**6.808956  #PATC06
#V0 = 10**6.296968  #PATC09
#V0 = 10**5.547272  #PATC10
...
t_exp = [0.04, 0.08, 0.17, 0.33, 0.50, 1.01, 1.50, 2.99]#, 6.03, 7.02, 9.98, 14.04, 21.03, 30.03]
...
plt.plot(ts, ys3)
plt.xlim(0.0, x[1])
plt.legend(["Exp data PATB17", "Modelo EDO"])
plt.show()