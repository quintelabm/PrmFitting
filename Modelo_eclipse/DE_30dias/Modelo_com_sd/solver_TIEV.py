...
def dinamica_Extracelular(y, t, s, d, beta, delta, epsilon, p, c, k):
...
if __name__ == "__main__":
    ...
    t_range, sol = solver(delta, epsilon, p, c, k, 10**AVERAGE_PATS[0], days)
    ...
    plt.savefig(cwd+"/Average.png", dpi=300)
