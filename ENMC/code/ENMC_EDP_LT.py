...
def plot_model_data(poi, V0):

    [tempo,V] = viralmodelfit(poi, V0)

    post_processing(tempo,V)

def plot_epsilons(poi, V0):
...
if __name__ == "__main__":
    ...
    poi = [0.999, 0.92, 0.300, 0.07, 22.0, 11.1, 12] #[0.999, 0.93753882, 0.2, 0.1, 19.93715449, 9.29497553, 9.71686742]
